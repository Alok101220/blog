...
import com.alok91340.blog.config.AppConstants;
...
import com.alok91340.blog.services.FileService;
...
public class PostController {
    ...
    public ResponseEntity<?> deletePostById(@PathVariable Integer postId){
        String message=this.postService.getPostById(postId).getTitle()+" deleted...";
    ...
    public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keyWord") String keyWord){
        List<PostDto> filterPosts=this.postService.searchPosts(keyWord);
        return new ResponseEntity<>(filterPosts,HttpStatus.OK);
    }
